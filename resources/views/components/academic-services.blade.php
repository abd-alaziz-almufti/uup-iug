...
$services = [
    ...
    [
        ...
        "button" => "عرض الجدول",
        "image" => "figma/Study schedule.png",
        "badge" => null,
    ],
    [
        "title" => "التسجيل",
