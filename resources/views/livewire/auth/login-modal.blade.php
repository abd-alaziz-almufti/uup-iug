    ...
    <div class="flex min-h-full items-center justify-center p-4">
            ...
            >
                ...
                <form wire:submit="login" class="w-full">
                    <div class="flex w-full flex-col gap-5 px-4">
                        ...
                        <button 
                            type="button" 
                            wire:click="toggleForgotPassword(true)"
        ...
        @else
            ...
            >
                ...
                <!-- Close Button -->
                <button 
                    wire:click="toggleForgotPassword(false)"
                ...
                <div class="mt-6 w-full max-w-[620px] space-y-4">
                    ...
                    <div class="relative">
                        <input 
                            ...
                            class="w-full rounded-[20px] bg-[#bfdeff] py-4 pl-4 pr-12 text-right font-tajawal text-lg text-black/70 outline-none focus:ring-2 focus:ring-blue-400/30"
                        />
